...
# 生成基本情報
html_file: "html_cache/tech-lab-sios-jp-archives-48196.html"
generated_at: "2025-07-15T09:09:40.091685"
...
input:
    ...
    web_fetch: 0
    user_input: 500
    non_cached_total: 19444
    total: 39444
output: 2000
processing_efficiency: 0.0507  # 出力/入力比率

# パフォーマンス情報
performance:
processing_time_seconds: 2.70
tokens_per_second: 14601
...
# ファイル情報
file_info:
html_file_path: "html_cache/tech-lab-sios-jp-archives-48196.html"
...
**生成情報**
- HTMLファイル: html_cache/tech-lab-sios-jp-archives-48196.html
- 生成日時: 2025-07-15 09:09:40
- プロンプトキャッシュ: 使用
- 生成方式: ダミー実装（API検証前）
